      ...
      <section className="py-12 md:py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
            ...
            providing personalized insights and recommendations to improve your
            resume.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card text-center bg-white dark:bg-gray-900">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Receive comprehensive insights about your skills, experience,
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card bg-white dark:bg-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                "This tool transformed my resume completely. I received three
                job offers within a month of implementing the suggestions!"
              </p>
            ...
            <div className="card bg-white dark:bg-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                "The skill visualization feature helped me identify gaps in my
                experience that I was able to address before applying to my
                dream job."
              </p>
              <div className="flex text-yellow-400 mt-3">
                <svg
            ...
            <div className="card bg-white dark:bg-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                "The leaderboard feature motivated me to keep improving my
                resume. My interview callback rate increased by 70% after using
                this tool!"
              </p>
              <div className="flex text-yellow-400 mt-3">
                <svg
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
            ...
            prospects with our resume analyzer.
          </p>
